...
from app.routes.worker_routes import (
...
from app.routes.protected_routes import (
    router as protected_router
)

from app.routes.location_routes import (
...
from app.routes.sos_routes import (
    router as sos_router
)

from app.routes.emergency_contact_routes import (
...
from app.routes.live_routes import (
...
def root():
    ...
    return {
        ...
        "message":
            "PA Backend Running Successfully"
    }